                ...
                <div className="cartBlock bg-light h-100 pb-5 flex-column">
                    <div className="mx-3 h-100 topBlock d-flex justify-content-between flex-wrap">
                        ...
                        <div className='w-100 container text-center'>
                            ...
                            <div className='text-black-50 my-2 font-weight-normal'>Для того, чтобы в корзине появились товары, необходимо их добавить</div>
                            <button onClick={cartClick} className='btn btn-success w-100 mt-3'>
                                Вернуться назад
                            </button>
                        </div>
                    </div>
